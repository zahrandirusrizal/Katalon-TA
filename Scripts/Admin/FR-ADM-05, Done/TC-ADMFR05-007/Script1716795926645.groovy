...
WebUI.setText(findTestObject('Object Repository/Menambah Staff/Input Username Staff atau Reviewer'), randomUsername)

WebUI.setEncryptedText(findTestObject('Object Repository/Menambah Staff/Input Password Staff atau Reviewer'), 'iGDxf8hSRT4=')
...
WebUI.verifyElementVisible(findTestObject('Menambah Staff/Notifications/Notifications of Password Not Valid'))

WebUI.verifyElementNotPresent(findTestObject('Menambah Staff/Toast/li_Berhasil'), 0)
