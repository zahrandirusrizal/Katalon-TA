...
WebUI.setText(findTestObject('Object Repository/Menambah Staff/Input Email Staff atau Reviewer'), 'format email yang dimasukkan tidak valid')
...
WebUI.verifyTextPresent('Email is invalid', false)
