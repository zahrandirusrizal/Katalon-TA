...
WebUI.setText(findTestObject('Menambah Staff/Input Nomor Telepon Staff atau Reviewer New'), 'Ini seharusnya hanya angka dan tidak boleh ada abjad')
...
WebUI.verifyTextPresent('Please enter a number.', false)
