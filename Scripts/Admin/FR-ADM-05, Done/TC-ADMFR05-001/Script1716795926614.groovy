...
WebUI.waitForElementVisible(findTestObject('Menambah Staff/Staff - Dropdown Option'), 5)

WebUI.click(findTestObject('Menambah Staff/Staff - Dropdown Option'))

WebUI.click(findTestObject('Menambah Staff/Button Tambah Akun Staff atau Reviewer'))

String toastMessageText = WebUI.getText(findTestObject('Menambah Staff/Toast/li_Berhasil'))
