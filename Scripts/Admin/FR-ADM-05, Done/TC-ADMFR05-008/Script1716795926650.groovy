...
WebUI.setEncryptedText(findTestObject('Object Repository/Menambah Staff/Input Password Staff atau Reviewer'), 'HFkVU+MMiWY=')
...
WebUI.verifyElementVisible(findTestObject('Menambah Staff/Notifications/Notifications of Konfirmasi Password Not Valid'))
