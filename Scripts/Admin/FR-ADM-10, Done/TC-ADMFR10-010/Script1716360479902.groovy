...
WebUI.click(findTestObject('Mengisi Fraud Assesment/Halaman Mengisi Fraud/Button Edit Paket Soal/Edit 6.1'))
...
if (WebUI.verifyElementPresent(findTestObject('Mengisi Fraud Assesment/Delete Button Edit/Nomor 11 - Button Delete Upload File'), 
    1, FailureHandling.OPTIONAL)) {
    WebUI.click(findTestObject('Mengisi Fraud Assesment/Delete Button Edit/Nomor 11 - Button Delete Upload File'))
...
if (WebUI.verifyElementPresent(findTestObject('Mengisi Fraud Assesment/Delete Button Edit/Nomor 12 - Button Delete Upload File'), 
    1, FailureHandling.OPTIONAL)) {
    WebUI.click(findTestObject('Mengisi Fraud Assesment/Delete Button Edit/Nomor 12 - Button Delete Upload File'))
...
if (WebUI.verifyElementPresent(findTestObject('Mengisi Fraud Assesment/Delete Button Edit/Nomor 13 - Button Delete Upload File'), 
    1, FailureHandling.OPTIONAL)) {
    WebUI.click(findTestObject('Mengisi Fraud Assesment/Delete Button Edit/Nomor 13 - Button Delete Upload File'))
...
if (WebUI.verifyElementPresent(findTestObject('Mengisi Fraud Assesment/Delete Button Edit/Nomor 14 - Button Delete Upload File'), 
    1, FailureHandling.OPTIONAL)) {
    WebUI.click(findTestObject('Mengisi Fraud Assesment/Delete Button Edit/Nomor 14 - Button Delete Upload File'))
...
if (WebUI.verifyElementPresent(findTestObject('Mengisi Fraud Assesment/Delete Button Edit/Nomor 15 - Button Delete Upload File'), 
    1, FailureHandling.OPTIONAL)) {
    WebUI.click(findTestObject('Mengisi Fraud Assesment/Delete Button Edit/Nomor 15 - Button Delete Upload File'))
