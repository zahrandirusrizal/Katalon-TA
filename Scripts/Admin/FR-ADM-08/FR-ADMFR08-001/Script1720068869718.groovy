...
String textToFind = 'Staff Perusahaan'
...
'Melakukan Proses Login'
WebUI.callTestCase(findTestCase('Staff/FR-STF-01, FR-STF-03/FR-STFFR01-001 - For Confirming login error'), [:], FailureHandling.STOP_ON_FAILURE)
