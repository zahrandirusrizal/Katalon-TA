...
WebUI.setText(findTestObject('Object Repository/Login Objects/Field Text Username Login'), 'alice_smith')

WebUI.setEncryptedText(findTestObject('Object Repository/Login Objects/Field Text Password Login'), 'jANLzMkvGDv4IsDJn20Yxw+JiSvks/vi')
