...
WebUI.setText(findTestObject('Object Repository/Login Objects/Field Text Username Login'), 'asdlkasfjelksajdl')

WebUI.setEncryptedText(findTestObject('Object Repository/Login Objects/Field Text Password Login'), 'P6VPnpzY4PL62HRFNzefGg==')
