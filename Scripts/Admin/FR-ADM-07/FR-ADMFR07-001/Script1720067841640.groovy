...
while (nextPageExists) {
    ...
    if (WebUI.verifyTextPresent(textToFind, false, FailureHandling.OPTIONAL)) {
        ...
        break // Adjust the delay time as per your requirement
...
if (!(textFound)) {
    ...
    WebUI.doubleClick(findTestObject('Melihat Data Staff/Page_Data Staf  Fraud Deterrence Propeller/Action Button Fixed Staff'))

    WebUI.doubleClick(findTestObject('Melihat Data Staff/Page_Data Staf  Fraud Deterrence Propeller/li_Aktif'))
}
