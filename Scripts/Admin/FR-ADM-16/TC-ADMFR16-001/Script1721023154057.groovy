...
WebUI.click(findTestObject('Fraud Detection/Page_Fraud Detection  Fraud Deterrence Propeller/Lihat Detail Kemungkinan tidak ada manipulasi'))

WebUI.verifyTextPresent('-2.9003', false)
