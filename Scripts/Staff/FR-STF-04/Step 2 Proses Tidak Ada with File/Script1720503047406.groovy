...
while (isMulaiVisible()) {
    ...
    switch (lastSegment) {
        case '1.1':
            ...
            WebUI.callTestCase(findTestCase('Test Cases/Admin/FR-ADM-09, Done/Jawaban Belum Ada/Dengan file upload/Mengisi 1.1'), 
        ...
        case '1.2':
            ...
            // Call the appropriate test case or perform actions here
            WebUI.callTestCase(findTestCase('Test Cases/Admin/FR-ADM-09, Done/Jawaban Belum Ada/Dengan file upload/Mengisi 1.2'), 
                [:], FailureHandling.STOP_ON_FAILURE)
        ...
        case '2.1':
            ...
            // Call the appropriate test case or perform actions here
            WebUI.callTestCase(findTestCase('Test Cases/Admin/FR-ADM-09, Done/Jawaban Belum Ada/Dengan file upload/Mengisi 2.1'), 
                [:], FailureHandling.STOP_ON_FAILURE)
        ...
        case '2.2':
            ...
            // Call the appropriate test case or perform actions here
            WebUI.callTestCase(findTestCase('Test Cases/Admin/FR-ADM-09, Done/Jawaban Belum Ada/Dengan file upload/Mengisi 2.2'), 
                [:], FailureHandling.STOP_ON_FAILURE)
        ...
        case '3.1':
            ...
            // Call the appropriate test case or perform actions here
            WebUI.callTestCase(findTestCase('Test Cases/Admin/FR-ADM-09, Done/Jawaban Belum Ada/Dengan file upload/Mengisi 3.1'), 
                [:], FailureHandling.STOP_ON_FAILURE)
        ...
        case '3.2':
            ...
            // Call the appropriate test case or perform actions here
            WebUI.callTestCase(findTestCase('Test Cases/Admin/FR-ADM-09, Done/Jawaban Belum Ada/Dengan file upload/Mengisi 3.2'), 
                [:], FailureHandling.STOP_ON_FAILURE)
        ...
        case '4.1':
            ...
            // Call the appropriate test case or perform actions here
            WebUI.callTestCase(findTestCase('Test Cases/Admin/FR-ADM-09, Done/Jawaban Belum Ada/Dengan file upload/Mengisi 4.1'), 
                [:], FailureHandling.STOP_ON_FAILURE)
        ...
        case '4.2':
            ...
            // Call the appropriate test case or perform actions here
            WebUI.callTestCase(findTestCase('Test Cases/Admin/FR-ADM-09, Done/Jawaban Belum Ada/Dengan file upload/Mengisi 4.2'), 
                [:], FailureHandling.STOP_ON_FAILURE)
        ...
        case '5.1':
            ...
            // Call the appropriate test case or perform actions here
            WebUI.callTestCase(findTestCase('Test Cases/Admin/FR-ADM-09, Done/Jawaban Belum Ada/Dengan file upload/Mengisi 5.1'), 
                [:], FailureHandling.STOP_ON_FAILURE)
        ...
        case '6.1':
            ...
            // Call the appropriate test case or perform actions here
            WebUI.callTestCase(findTestCase('Test Cases/Admin/FR-ADM-09, Done/Jawaban Belum Ada/Dengan file upload/Mengisi 6.1'), 
                [:], FailureHandling.STOP_ON_FAILURE)
