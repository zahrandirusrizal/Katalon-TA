...
WebUI.click(findTestObject('Fraud Detection/Page_Fraud Detection  Fraud Deterrence Propeller/Lihat Detail Kemungkinan ada manipulasi'))

WebUI.verifyTextPresent('12.5427', false)
