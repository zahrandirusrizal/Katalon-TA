...
while (nextPageExists) {
    ...
    if (WebUI.verifyTextPresent(textToFind, false, FailureHandling.OPTIONAL)) {
        ...
        if (WebUI.verifyElementClickable(findTestObject('Object Repository/Reviewer Tab/Next Page Button Reviewer Table'), FailureHandling.OPTIONAL)) {
            try {
