...
WebUI.click(findTestObject('Reviewer Tab/Button Beri Nilai'))

WebUI.waitForElementVisible(findTestObject('Reviewer Tab/Itikad Menilai/Pernyataan Itikad Menilai'), 3)

WebUI.click(findTestObject('Reviewer Tab/Itikad Menilai/Checkbox Persetujuan Pernyataan'))

WebUI.doubleClick(findTestObject('Reviewer Tab/Itikad Menilai/Button Memulai Penilaian'))
