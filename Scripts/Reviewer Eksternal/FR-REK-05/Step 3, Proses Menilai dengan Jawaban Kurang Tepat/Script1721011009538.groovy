...
//to check if there is any assesment that can be graded
...
while (isMulaiPenilaianVisible()) {
    ...
    switch (lastSegment) {
        case '1.1':
            ...
            WebUI.callTestCase(findTestCase('Reviewer Internal/FR-RIN-05/Menilai Per Sub Bab/Jawaban Kurang Tepat/Menilai 1.1'), 
        ...
        case '1.2':
            ...
            // Call the appropriate test case or perform actions here
            WebUI.callTestCase(findTestCase('Reviewer Internal/FR-RIN-05/Menilai Per Sub Bab/Jawaban Kurang Tepat/Menilai 1.2'), 
                [:], FailureHandling.STOP_ON_FAILURE)
        ...
        case '2.1':
            ...
            // Call the appropriate test case or perform actions here
            WebUI.callTestCase(findTestCase('Reviewer Internal/FR-RIN-05/Menilai Per Sub Bab/Jawaban Kurang Tepat/Menilai 2.1'), 
                [:], FailureHandling.STOP_ON_FAILURE)
        ...
        case '2.2':
            ...
            // Call the appropriate test case or perform actions here
            WebUI.callTestCase(findTestCase('Reviewer Internal/FR-RIN-05/Menilai Per Sub Bab/Jawaban Kurang Tepat/Menilai 2.2'), 
                [:], FailureHandling.STOP_ON_FAILURE)
        ...
        case '3.1':
            ...
            // Call the appropriate test case or perform actions here
            WebUI.callTestCase(findTestCase('Reviewer Internal/FR-RIN-05/Menilai Per Sub Bab/Jawaban Kurang Tepat/Menilai 3.1'), 
                [:], FailureHandling.STOP_ON_FAILURE)
        ...
        case '3.2':
            ...
            // Call the appropriate test case or perform actions here
            WebUI.callTestCase(findTestCase('Reviewer Internal/FR-RIN-05/Menilai Per Sub Bab/Jawaban Kurang Tepat/Menilai 3.2'), 
                [:], FailureHandling.STOP_ON_FAILURE)
        ...
        case '4.1':
            ...
            // Call the appropriate test case or perform actions here
            WebUI.callTestCase(findTestCase('Reviewer Internal/FR-RIN-05/Menilai Per Sub Bab/Jawaban Kurang Tepat/Menilai 4.1'), 
                [:], FailureHandling.STOP_ON_FAILURE)
        ...
        case '4.2':
            ...
            // Call the appropriate test case or perform actions here
            WebUI.callTestCase(findTestCase('Reviewer Internal/FR-RIN-05/Menilai Per Sub Bab/Jawaban Kurang Tepat/Menilai 4.2'), 
                [:], FailureHandling.STOP_ON_FAILURE)
        ...
        case '5.1':
            ...
            // Call the appropriate test case or perform actions here
            WebUI.callTestCase(findTestCase('Reviewer Internal/FR-RIN-05/Menilai Per Sub Bab/Jawaban Kurang Tepat/Menilai 5.1'), 
                [:], FailureHandling.STOP_ON_FAILURE)
        ...
        case '6.1':
            ...
            // Call the appropriate test case or perform actions here
            WebUI.callTestCase(findTestCase('Reviewer Internal/FR-RIN-05/Menilai Per Sub Bab/Jawaban Kurang Tepat/Menilai 6.1'), 
                [:], FailureHandling.STOP_ON_FAILURE)
