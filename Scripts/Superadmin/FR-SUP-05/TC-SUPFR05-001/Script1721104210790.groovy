...
WebUI.click(findTestObject('Superadmin Pages/Page_Fraud Assesment - Accounts  Fraud Deterrence Propeller/button_Pilih Status'))

WebUI.doubleClick(findTestObject('Superadmin Pages/Page_Fraud Assesment - Accounts  Fraud Deterrence Propeller/li_Tolak'))
