...
String textToFind = 'iflab@example.com'
...
if (!(textFound)) {
    ...
    WebUI.doubleClick(findTestObject('Object Repository/Superadmin Pages/Page_Create Next App/button_Aktif'))
	
	WebUI.delay(3)

    WebUI.click(findTestObject('Object Repository/Superadmin Pages/Page_Create Next App/li_Nonaktif'))
}
...
'Melakukan Proses Login'
WebUI.callTestCase(findTestCase('Admin/FR-ADM-02. FR-ADM-04, Done/TC-ADMFR02-001 for login error'), [:], FailureHandling.STOP_ON_FAILURE)
